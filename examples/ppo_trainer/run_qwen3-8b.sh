...
cd /mnt/shared-storage-user/p1-shared/zhangqingyang/kxk2/verl-ppo/
...
export WANDB_DIR="/mnt/shared-storage-user/p1-shared/zhangqingyang/kxk2/wandb/ppo"

export VLLM_USE_V1=1

project_name='PPO-verl'
...
# 定义日志文件路径
LOG_DIR="/mnt/shared-storage-user/p1-shared/zhangqingyang/kxk2/logs/ppo"
