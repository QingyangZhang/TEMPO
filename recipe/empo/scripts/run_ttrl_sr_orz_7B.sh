...
exp_name="LaSeR-ORZ-7B-${DATE}:${TIME_TAG}"
...
HYDRA_FULL_ERROR=1 python3 -m recipe.empo.src.main_dapo \
    ...
    +algorithm.enable_self_rewarding=True \
    ...
    +actor_rollout_ref.ref.pad_token_id=151643 \
    +actor_rollout_ref.ref.self_reward_token_id=151652 \
    ...
    +trainer.rollout_data_dir=path/to/resource \
