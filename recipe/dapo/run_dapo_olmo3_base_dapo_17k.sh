...
project_name='TEMPO-OLMO3-Critic'
...
exp_name="Olmo3-7B-base-grpo-dapo-17k-${DATE}:${TIME_TAG}"
LOG_DIR="path/to/resource"
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/Olmo3-7B-base-${DATE}_${TIME_TAG}.log"
