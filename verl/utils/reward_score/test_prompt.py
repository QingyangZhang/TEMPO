...
os.environ['NO_PROXY'] = '10.102.247.32,localhost,127.0.0.1'
...
#10.102.247.32
#34812
# base url is http://10.102.247.32:34812/v1
client = openai.OpenAI(api_key="none", base_url="http://10.102.247.32:34812/v1")

user_prompt = user_prompt.format(Problem_Statement="For what value of $B_0$ does the total current $I_J = 0$?", Model_Answer="B_{0} = \\\\dfrac{n \\\\pi \\\\hbar}{e (d + 2\\\\lambda) Y} \\\\quad (n = \\\\pm 1, \\\\pm 2, \\\\dots)", Golden_Answer="$B_0 = n \\\\frac{\\\\pi \\\\hbar}{e (d + 2\\\\lambda)Y}$ where $n = \\\\pm 1, \\\\pm 2, ...$")
